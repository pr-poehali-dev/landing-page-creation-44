...
const Index = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "БАРТЕР",
      note: "Мы ничего не платим вам, вы ничего не платите нам — вы делаете нам массовую рекламу. Либо предоставляете услуги, необходимые для проведения конференции.",
      features: [
        "Размещение на сайте конференции",
        "Вставка логотипа на общем рекламном плакате",
        "Вкладыш в промо пакет участникам (создаете свою рекламу со специальным предложением)"
